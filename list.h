...
/*
 * This file is from the Linux kernel headers.
 * It is simpler and defines only
 * one list type: circular double linked list with
 * no prefetching and no concurrency control
 * -hroeck
 */
...
static inline void __list_splice(struct list_head *head, struct list_head *list)
{
